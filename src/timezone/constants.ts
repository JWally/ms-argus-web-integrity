/**
 * Timezone Detection Constants
 *
 * IANA timezone database identifiers for location fingerprinting.
 * The browser's reported timezone can reveal the user's geographic location.
 *
 * @see https://github.com/vvo/tzdb
 ...
 *
 * Using a year from 1113 ensures we're comparing timezone behavior
 * in a period before modern DST rules, making the comparison more
 * stable and less dependent on recent political timezone changes.
 */
 ...
 * timezone offset with historical offset data for each city.
 *
 * The list is organized by region:
 * - UTC/GMT and Etc/* variants
 * - Africa (52 zones)
 * - America (147 zones)
 * - Antarctica (11 zones)
 * - Arctic (1 zone)
